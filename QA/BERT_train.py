...
def main(args):
    ...
    evolution_file = open('/home/projects/cpr_10006/people/enrcop/loss_files/BERT_train/' + args.BERT_type + '/' + args.case + '_' + args.BERT_tokens + '_' + str(args.num_bins) + '.txt', "w") # train_loss_no_cls_no_desc_no_ret_small_0.0125_10000_2.0.txt', "w")

    # Save model and training losses
    save_model = '/home/projects/cpr_10006/people/enrcop/models/BERT_train/' + args.BERT_type + '/' + args.case + '_' + args.BERT_tokens + '_' + str(args.num_bins) + '.pt' #BERT_small/BERT_small_no_CLS_no_desc_no_rettime_0.0125_10000_2.0.pt'
    save_plot = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_train/' + args.BERT_type + '/' + args.case + '_' + args.BERT_tokens + '_' + str(args.num_bins) + '.png' #_no_CLS_no_desc_no_rettime_0.0125_10000_2.0.png'
    ...
    if args.BERT_type == 'BERT_small':
        d_model = 10; d_hid = 10; nhead = 2; nlayers = 2
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if val_loss < best_val_loss:
            ...
            if early_stopping_counter > 3:
                ...
                plot_loss(epoch, [lr], training_error, validation_error, pathway=save_plot)
                exit()

    # If we get to the end of the simulation:
    torch.save({'epoch': epoch,
                    'model_state_dict': best_model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict(),
                    'loss': train_loss
    ...
    plot_loss(n_epochs, [lr], training_error, validation_error, pathway=save_plot)
