...
with cProfile.Profile() as pr:
    ...
    evolution_file = open('/home/projects/cpr_10006/people/enrcop/TEST/clean_code/train_error.txt', "w")

    # Define the model network for training BERT model

    model = TransformerModel(ntoken=len(vocab),  # size of vocabulary 
                            d_model= 192, #384, # embedding dimension
                            d_hid= 192, #384, # dimension of the feedforward network model in nn.TransformerEncoder
                            nhead= 3, #6, # number of nn.TransformerEncoderLayer in nn.TransformerEncoder
                            nlayers= 3, #6, # number of heads in nn.MultiheadAttention
    ...
    scheduler.step() # Initialize scheduler so lr starts warmup from 0 as we want
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if val_loss < best_val_loss:
            ...
            torch.save({'epoch': epoch,
                        ...
                        'loss': train_loss
                        }, '/home/projects/cpr_10006/people/enrcop/models/BERT_train/BERT_half/BERT_half_noCLS_norettime.pt')

    save_plot = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_train/BERT_half_noCLS_norettime.png'
    #save_plot = '/home/projects/cpr_10006/people/enrcop/TEST/clean_code/test_figures/BERT_train.png'
