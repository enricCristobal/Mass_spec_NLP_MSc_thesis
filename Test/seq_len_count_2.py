...
def token_counter(input_dir, peak_filter:float):
    ...
    for filename in os.listdir(input_dir): 
        ...
        #if filename == '20190517_QE10_Evosep1_P0000005_LiNi_SA_Plate2_A1.raw.pkl':
...
count_vector = token_counter (input_dir=scans_dir, peak_filter=1)
...
#plt.savefig('/home/projects/cpr_10006/people/enrcop/Figures/sen_len_hist')
plt.show()