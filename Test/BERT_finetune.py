...
evolution_file = open('/home/projects/cpr_10006/people/enrcop/loss_files/finetune_loss_group2_no_cls_no_desc_no_rettime_0.0125_10000.txt', "w")
## LOCAL PATHWAY
...
train_finetune_ds, val_finetune_ds, num_labels, min_scan_count = FineTuneBERTDataLoader(files_dir, vocab, training_percentage=0.7, validation_percentage=0.3, \
...
for epoch in range(1, epochs + 1):
    ...
    val_loss, acc = BERT_finetune_evaluate(new_BERT_model, model, criterion, dataset=val_finetune_ds, results_file=evolution_file, 
...
error_plot_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/BERT_small/no_CLS_no_desc_no_rettime_0.0125_10000/Group2_HPvsALD/finetune_error.png'
att_weights_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/BERT_small/no_CLS_no_desc_no_rettime_0.0125_10000/Group2_HPvsALD/att_weights.png'
