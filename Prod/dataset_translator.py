...
tokens_dir = '/home/projects/cpr_10006/projects/gala_ald/data/plasma_scans/BERT_tokens/no_CLS_no_desc_no_rettime_tokens/'

# LOCAL PATHWAYS!
#scans_dir = 'C:\\Users\\enric\\OneDrive\\Escriptori\\TFM\\01_Code\\Code\\Test\\pickle_data\\' 
#tokens_dir = 'C:\\Users\\enric\\OneDrive\\Escriptori\\TFM\\01_Code\\Code\\Test\\test_data\\' 
...
input_size = 512 # natural BERT size (later size reductions will be done later if needed)
CLS_token = False # if we want to add CLS token at the beginning of each sentence
descending_order = False # decide if we want to sort bins by descending intensity
retention_time = False # decide if we want to include retention time at the beginning of "sentence" followed by SEP token
