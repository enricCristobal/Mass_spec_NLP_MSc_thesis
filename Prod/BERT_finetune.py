...
evolution_file = open('/home/projects/cpr_10006/people/enrcop/PROD/dummy_results/finetune.txt', "w")
...
train_finetune_ds, val_finetune_ds, num_labels = FineTuneBERTDataLoader(files_dir, vocab, training_percentage=0.05, validation_percentage=0.01, \
...
attention_network = AttentionNetwork(n_input_features = 192, n_layers = 2, n_units =10)
...
for epoch in range(1, epochs + 1):
    ...
    val_loss = BERT_finetune_evaluate(BERT_model, model, criterion, dataset=val_finetune_ds, results_file=evolution_file, 
