...
train_ds, val_ds = TrainingBERTDataLoader(files_dir, vocab, num_bins, training_percentage=0.4, \
    validation_percentage=0.2, CLS_token=False, add_ret_time=True, data_repetition=3)
