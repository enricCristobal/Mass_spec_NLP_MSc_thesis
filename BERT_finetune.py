...
"""
Main file for the fine-tuning of BERT with different
architectures.
...
def main(args):
    ...
    evolution_file = open('/home/projects/cpr_10006/people/enrcop/loss_files/BERT_finetune/' + args.BERT_type + '/' + class_param_long + '/' + args.case +  '_' + args.BERT_tokens + '_' + str(args.num_bins) + '_' + str(args.data_repetition) + '_' + str(args.class_layer) + '_' + str(args.att_matrix) + '.txt', "w")
    ...
    # Figures pathways
    error_plot_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/' + args.BERT_type + '/' + class_param_long + '/' + args.case + '_' + args.BERT_tokens +  '_' + str(args.num_bins) + '_' + str(args.data_repetition) + '_' + str(args.class_layer) + '_' + str(args.att_matrix) + '_loss.png'
    att_weights_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/' + args.BERT_type + '/' + class_param_long + '/' + args.case + '_' + args.BERT_tokens +  '_' + str(args.num_bins) + '_' + str(args.data_repetition) + '_' + str(args.class_layer) + '_' + str(args.att_matrix) + '_att_weigths.png'
    ROC_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/' + args.BERT_type + '/' + class_param_long + '/' + args.case + '_' + args.BERT_tokens +  '_' + str(args.num_bins) + '_' + str(args.data_repetition) + '_' +  str(args.class_layer) + '_' + str(args.att_matrix)+ '_ROC_curve.png'
    cm_pathway = '/home/projects/cpr_10006/people/enrcop/Figures/BERT_finetune/' + args.BERT_type + '/' + class_param_long + '/' + args.case + '_' + args.BERT_tokens +  '_' + str(args.num_bins) + '_' + str(args.data_repetition) + '_' + str(args.class_layer) + '_' + str(args.att_matrix) + 'conf_matrix.png'
